...
<head>
    ...
    <meta name="description" content='前端框架，基于最新版EasyUI前端框架构建，纯HTML调用功能组件，不用写JS代码的EasyUI，专注你的后端业务开发！'/>
    <title>JSS运营数据系统</title>
    <!-- 浏览器标签图片 -->
    <link rel="shortcut icon" href="<%=request.getContextPath()%>/jsp/topjui/image/favicon.ico"/>
    <!-- TopJUI框架样式 -->
    ...
    <!-- 首页js -->
    <script type="text/javascript" src="<%=request.getContextPath()%>/jsp/static/public/js/topjui.index.js" charset="utf-8"></script>
</head>
...
<div data-toggle="topjui-layout" data-options="id:'index_layout',fit:true">
    <div id="north" class="banner" data-options="region:'north',border:false,split:false"
        ...
        <table style="float:left;border-spacing:0px;">
            <tr>
                <td class="webname">
                    <span class="fa fa-envira" style="font-size:26px; padding-right:8px;"></span>JSS运营数据系统
                </td>
                ...
                <td>
                    ...
                    <shiro:hasPermission name="userdata">
						<td id="000" title="用户数据" class="topmenu selected systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-user"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">用户数据</span></p>
                            </a>
                        </td>
                        </shiro:hasPermission>
                         <shiro:hasPermission name="orderdata">
                        <td id="001" title="订单数据" class="topmenu selected systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-hand-pointer-o"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">订单数据</span></p>
                            </a>
                        </td>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="restaurantsdata">
                        <td id="002" title="商户数据" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-sort-amount-asc"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">商户数据</span></p>
                            </a>
                        </td>
                          </td>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="deliverydata">
                                  <td id="003" title="配送数据" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-puzzle-piece"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">配送数据</span></p>
                            </a>
                        </td> 
                          </shiro:hasPermission>
                        <shiro:hasPermission name="financialdata">
                        <td id="004" title="财务数据" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa  fa-shield"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">财务数据</span></p>
                            </a>
                      </td>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="marketingdata">
                          <td id="006" title="营销数据" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-heartbeat"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">营销数据</span></p>
                            </a>
                      </td>
                      </shiro:hasPermission>
                      <shiro:hasPermission name="jibenshezhi">
                          <td id="005" title="基本设置" class="topmenu systemName">
                            <a class="l-btn-text bannerMenu" href="javascript:void(0)">
                                <p>
                                    <lable class="fa fa-list"></lable>
                                </p>
                                <p><span style="white-space:nowrap;">基本设置</span></p>
                            </a>
                      </td>
                      </shiro:hasPermission>
        ...
        <span style="float: right; padding-right: 10px; height: 50px; line-height: 50px;">
            <a href="javascript:void(0)" onclick="return false;" data-toggle="topjui-menubutton"
    ...
    <div id="center" data-options="region:'center',border:false" style="overflow:hidden;">
        <div id="index_tabs" style="width:100%;height:100%">
            ...
            content:'<iframe src=\'<%=request.getContextPath()%>/jsp/html/portal/index.html\' scrolling=\'auto\' frameborder=\'0\' style=\'width:100%;height:100%;\'></iframe>'"></div>
        </div>
    </div>
    ...
    <div data-options="region:'south',border:true"
        ...
        <span style="padding-right:5px;width:40%">
            版权所有 © 2014-2018
            <a href="http://www.wangang.cc/" target="_blank">JSS</a>
            <a href="#" target="_blank"></a>
        </span>
        <span style="float:right;padding-right:5px;width:30%;text-align: right;">版本：v1.0</span>
    </div>
</div>
