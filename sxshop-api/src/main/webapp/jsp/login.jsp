...
<head>
    ...
    <title>${data } - 用户登录</title>
    <!-- 浏览器标签图片 -->
    <link rel="shortcut icon" href="<%=request.getContextPath()%>/jsp/topjui/image/favicon.ico"/>
    <link rel="stylesheet" href="<%=request.getContextPath()%>/jsp/static/plugins/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/jsp/static/plugins/font-awesome/css/font-awesome.min.css">
    <style type="text/css">
        html, body {
            height: 100%;
        }
        ...
        .box {
            background: url("<%=request.getContextPath()%>/jsp/topjui/image/loginBg.jpg") no-repeat center center;
...
<script src="<%=request.getContextPath()%>/jsp/static/plugins/bootstrap/js/bootstrap.min.js"></script>
                    ...
                    success: function (data) {
                        if (data.statusCode == 200) {
                           // location.href = '/system/index/index?portal=${portal}';
                        	...
                        	$('#span_id').html("<i class='fa fa-warning'></i>   "+data.message);
                            $('#myModal').modal();
                            //alert("用户名或密码错误！");
                        }
                    },
