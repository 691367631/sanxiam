...
<div id="productDg-toolbar" class="topjui-toolbar"
   ...
   <a id="add" href="javascript:void(0)">新增</a>
    ...
    <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/deliverydata/exportReportDetails">
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/deliverydata/delivery_people_account_checkingDetailsJson',
            columns: [[
                ...
                {field: 'pay_method', title: '支付方式', sortable: true,width:'100px'},
                {field: 'delivery_person_id', title: '送餐员id', sortable: true,width:'120px'},
                {field: 'delivery_fee', title: '配送费', sortable: true,width:'100px'},
                {field: 'line_cost_total', title: '菜品金额', sortable: true,width:'100px'},
                {field: 'customer_total', title: '客人应付', sortable: true,width:'100px'},
                {field: 'customer_paid_total', title: '客人实付', sortable: true,width:'100px'},
                {field: 'packing_fee', title: '餐盒费', sortable: true,width:'100px'},
                {field: 'acmount', title: '送餐员应付利润', sortable: true,width:'100px'},
                {field: 'delivery_people_name', title: '送餐员名称', sortable: true,width:'100px'},
