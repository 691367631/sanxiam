...
<div id="productDg-toolbar" class="topjui-toolbar"
   ...
   <a id="add" href="javascript:void(0)">新增</a>
    ...
    <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/deliverydata/exportReportCancelOrder">
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/deliverydata/cancelOrderJson',
            columns: [[
                ...
                {field: 'dispatched_at', title: '客服分配时间', sortable: true,width:'100px'},
                {field: 'order_cancelled_at', title: '订单取消时间', sortable: true,width:'100px'},
                {field: 'reason_for_cancellation', title: '订单取消原因', sortable: true,width:'100px'},
            ]],
