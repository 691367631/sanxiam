...
<div id="productDg-toolbar" class="topjui-toolbar"
   ...
   <a id="add" href="javascript:void(0)">新增</a>
    ...
    <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/deliverydata/exportReportTimeing">
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/deliverydata/timeingJson',
            columns: [[
                ...
                {field: 'reserved_at', title: '预定时间', sortable: true,width:'100px'},
                {field: 'created_at', title: '创建时间', sortable: true,width:'100px'},
                {field: 'order_confirmed_at', title: '客服确认订单时间', sortable: true,width:'100px'},
                {field: 'biz_confirmed_at', title: '商家确认时间', sortable: true,width:'100px'},
                {field: 'dispatched_at', title: '客服分配订单时间', sortable: true,width:'100px'},
                {field: 'delivery_order_at', title: '配送员接单时间', sortable: true,width:'100px'},
                {field: 'biz_catering_complete', title: '商家备餐完成时间', sortable: true,width:'100px'},
                {field: 'arrived_store_at', title: '配送员到店时间', sortable: true,width:'100px'},
                {field: 'dish_fetched_at', title: '配送员取餐时间', sortable: true,width:'100px'},
                {field: 'delivered_at', title: '配送员送达时间', sortable: true,width:'100px'},
                {field: 'reminder_time', title: '催单时间', sortable: true,width:'100px'},
                {field: 'all_time', title: '订单总耗时', sortable: true,width:'100px'},
                {field: 'restaurant_time', title: '餐厅备餐耗时', sortable: true,width:'100px'},
                {field: 'delivered_time', title: '配送耗时', sortable: true,width:'100px'}
            ]],
