...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/deliverydata/listJson',
            columns: [[
                {field: 'uuid', title: 'UUID', checkbox: true,width:'100px'},
                {field: 'delivery_people_id', title: '送餐员id', sortable: true,width:'100px'},
                {field: 'delivery_people_name', title: '送餐员姓名', sortable: true,width:'120px'},
                {field: 'owner', title: 'OWNER', sortable: true,width:'100px'},
                {field: 'amount', title: 'AMOUNT', sortable: true,width:'100px'},
                {field: 'city', title: 'CITY', sortable: true,width:'120px'}
            ]],
