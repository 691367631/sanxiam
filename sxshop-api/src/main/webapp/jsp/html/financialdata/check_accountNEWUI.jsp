...
<div id="productDg-toolbar" class="topjui-toolbar"
   ...
   <!--    <a id="edit" href="javascript:void(0)">生成</a>
    ...
    <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/financialdata/check_accountexportNEWReport">
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/financialdata/check_accountNEWJson',
            columns: [[
                ...
                {field: 'delivery_fee', title: '配送费', sortable: true,width:'120px'},
             ...
             /*    {field: 'acmount', title: '骑手利润', sortable: true,width:'120px'}, */
                ...
                {field: 'reserved_at', title: '预定时间', sortable: true,width:'120px'},
