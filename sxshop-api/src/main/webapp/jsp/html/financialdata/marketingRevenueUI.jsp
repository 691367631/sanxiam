...
<div id="productDg-toolbar" class="topjui-toolbar"
   ...
   <!--    <a id="edit" href="javascript:void(0)">生成</a>
    ...
    <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/financialdata/marketingRevenueReport">
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/financialdata/marketingRevenueJson',
            columns: [[
                {field: 'payment_sn', title: '支付流水号', sortable: true,width:'100px'},
                {field: 'amount', title: '支付金额', sortable: true,width:'100px'},
                {field: 'pay_status', title: '支付状态', sortable: true,width:'100px'},
                {field: 'pay_type', title: '支付类型', sortable: true,width:'100px'},
                {field: 'pay_method', title: '支付方式', sortable: true,width:'120px'},
                {field: 'card_name_zh_cn', title: '产品名称', sortable: true,width:'100px'},
                {field: 'trade_id', title: '第三方支付单号', sortable: true,width:'120px'},
                {field: 'created_at', title: '支付时间', sortable: true,width:'120px'},
            ]],
