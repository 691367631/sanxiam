  ...
  <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/deliverydata/exportReport">
   ...
   <br> 
    ...
    <script type="text/javascript">
        ...
        $.get('<%=request.getContextPath()%>/orderdata/ordersumData?_easyui_textbox_input1='+createTimebegin+'&_easyui_textbox_input2='+createTimeend, function (data) {
