...
<div id="productDg-toolbar" class="topjui-toolbar"
   ...
   <!--    <a id="edit" href="javascript:void(0)">生成</a>
    ...
    <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/orderdata/reviewsOrderReport">
         <input  type="text" data-toggle="topjui-datebox" data-options="id:'text',prompt:'支付开始时间',pattern:'YYYY-mm-dd'" id="createTimebegin" name="createTimebegin" value="" > 
     <input type="text" data-toggle="topjui-datebox" data-options="id:'text2',prompt:'支付结束时间',pattern:'YYYY-mm-dd'" id="createTimeend" name="createTimeend" value="">
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/orderdata/reviewsOrderJson',
            columns: [[
                {field: 'user_id', title: '用户id', sortable: true,width:'100px'},
                {field: 'number', title: '订单编号', sortable: true,width:'100px'},
                {field: 'rating', title: '餐厅评分', sortable: true,width:'100px'},
                {field: 'rest_comment', title: '餐厅评论', sortable: true,width:'120px'},
                {field: 'restaurant_id', title: '餐厅id', sortable: true,width:'100px'},
                {field: 'name_zh_cn', title: '餐厅名称', sortable: true,width:'100px'},
                {field: 'delivery_rating', title: '骑手评分', sortable: true,width:'200px'},
                {field: 'delivery_comment', title: '骑手评论', sortable: true,width:'100px'},
                {field: 'nickname', title: '骑手名字', sortable: true,width:'100px'},
                {field: 'detil', title: '用户详细信息', sortable: true,width:'100px'},
                {field: 'created_at', title: '评论时间', sortable: true,width:'120px'},
