...
<div id="productDg-toolbar" class="topjui-toolbar"
    ...
    <a id="edit" href="javascript:void(0)">查看</a>
    ...
    <form id="queryForm" class="search-box">
        <input type="text" name="text" data-toggle="topjui-textbox"
               data-options="id:'text',prompt:'订单编号'">
        <input type="text" name="serialno" data-toggle="topjui-textbox"
               data-options="id:'serialno',prompt:'用户id'">
...
<script>
    ...
    $(function () {
        ...
        $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/orderdata/listJson',
            columns: [[
                {field: 'id', title: 'id', checkbox: true},
                {field: 'orderId', title: '订单编号', sortable: true},
                {field: 'userId', title: '用户id', sortable: true},
                {field: 'amount', title: '价格', sortable: true},
                {field: 'payType', title: '支付类型', sortable: true},
                {field: 'payMethod', title: '支付方式', sortable: true},
                {field: 'createdAtstr', title: '创建时间', sortable: true},
                {field: 'transactionId', title: '事物id', sortable: true}
            ]],
        ...
        $("#add").iMenubutton({
            ...
            dialog: {
                id: 'userAddDialog',
                height: 350,
                href:'<%=request.getContextPath()%>/menu/addUI',
                buttonsGroup: [
                    {
                        text: '保存',
        ...
        $("#edit").iMenubutton({
            ...
            dialog: {
                width: 950,
                height: 500,
                href:'<%=request.getContextPath()%>/menu/editUI?serialno={serialno}',
                buttonsGroup: [
                    {
                        text: '更新',
