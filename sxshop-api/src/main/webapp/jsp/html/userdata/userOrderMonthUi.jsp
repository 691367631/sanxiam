...
<div>
<a id="queryBtn"  onclick="data()">数据</a>
   <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/deliverydata/exportReport">
  
<!--     <input  type="text" data-toggle="topjui-datebox" data-options="id:'text',prompt:'用户注册开始时间',pattern:'YYYY-mm-dd'" id="createTimebegin" name="createTimebegin" value="" > 
   <br> -->
     <input type="text" data-toggle="topjui-datebox" data-options="id:'text1',prompt:'开始时间',pattern:'YYYY-mm'"  >
     <input type="text" data-toggle="topjui-datebox" data-options="id:'text2',prompt:'结束时间',pattern:'YYYY-mm'"  >
    ...
    <script type="text/javascript">
        ...
        /* 	var begin='${_easyui_textbox_input1}';
            var end="${_easyui_textbox_input2}";
            alert(begin);
        	if(begin!="开始时间"&begin!=null&typeof(begin)!="undefined"){
        		alert(createTimebegin);
        		createTimebegin=begin;
        		$('#_easyui_textbox_input1').val(begin);
        	}
        	if(end!="结束时间"&end!=null&typeof(end)!="undefined"){
        		createTimeend=end;
        		$('#_easyui_textbox_input2').val(end);
        	}
        	alert(createTimebegin); */
        $.get('<%=request.getContextPath()%>/userdata/usersMonthOrderList?_easyui_textbox_input1='+createTimebegin+'&_easyui_textbox_input2='+createTimeend, function (data) {
       ...
       function  data(){
    	   var createTimebegin=$('#_easyui_textbox_input1').val();
           var createTimeend=$('#_easyui_textbox_input2').val();
        	window.location.href="<%=request.getContextPath()%>/userdata/usersMonthOrderListData?_easyui_textbox_input1="+createTimebegin+"&_easyui_textbox_input2="+createTimeend;
        }
    </script>
</body>
</html>