...
<body onload="queryBtn()">
   ...
   <br> 
    ...
    <script type="text/javascript">
        ...
        $.get('<%=request.getContextPath()%>/userdata/ordercountData?_easyui_textbox_input1='+createTimebegin+'&_easyui_textbox_input2='+createTimeend, function (data) {
