...
<div id="productDg-toolbar" class="topjui-toolbar"
   ...
   <!--    <a id="edit" href="javascript:void(0)">生成</a>
    ...
    <form id="queryForm" class="search-box" action="<%=request.getContextPath()%>/marketingdata/deliveryCardOrderDatalistReport">
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/marketingdata/deliveryCardOrderDatalistJson',
            columns: [[
                {field: 'number', title: '订单编号', sortable: true,width:'100px'},
                {field: 'delivered_at', title: '订单送达时间', sortable: true,width:'100px'},
                {field: 'order_status', title: '订单状态', sortable: true,width:'200px'},
                {field: 'user_id', title: '用户id', sortable: true,width:'100px'},
                {field: 'detil', title: '订单详细信息', sortable: true,width:'100px'},
                {field: 'TYPE', title: '方式', sortable: true,width:'100px'},
                {field: 'create_time', title: '获得配送卡时间', sortable: true,width:'100px'},
            ]],
