...
<div id="productDg-toolbar" class="topjui-toolbar"
    ...
    <form id="queryForm" class="search-box">
        <input type="text" name="text" data-toggle="topjui-textbox"
               data-options="id:'text',prompt:'菜单名称'">
        <input type="text" name="serialno" data-toggle="topjui-textbox"
               data-options="id:'serialno',prompt:'菜单编号'">
...
<script>
    ...
    $(function () {
        ...
        $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/menu/listJson',
            columns: [[
                {field: 'uuid', title: 'UUID', checkbox: true},
                {field: 'id', title: '菜单编号', sortable: true},
                {field: 'text', title: '菜单名称', sortable: true},
                {field: 'pid', title: '父级菜单', sortable: true},
