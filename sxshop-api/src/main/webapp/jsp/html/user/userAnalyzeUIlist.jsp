  ...
  <a id="export"  href="javascript:void(0)" onclick="expor1tReport()">导出</a>
   ...
   <a id="export"  href="javascript:void(0)" onclick="send(1)">发送邮箱</a> 
    ...
    <select name="mobileAndemail"  data-options="required:true">
		...
		版本号：
		 <select  name="login_version"    data-options="required:true">
  			<option value ="">全部</option>
    ...
    <input type="text" id="keywords" name="keywords" data-toggle="topjui-textbox"
               data-options="id:'text3',prompt:'关键字:手机号,昵称,邮箱'"> 
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/userdata/userAnalyzelistJson',
            columns: [[
             ...
             /*    {field: 'orderUserName', title: '最近一次订单用户姓名', sortable: true},
                ...
                {field: 'last_login_time', title: '最后一次登录时间', sortable: true},
                {field: 'login_version', title: '最后一次登录版本号', sortable: true}
            ]],
