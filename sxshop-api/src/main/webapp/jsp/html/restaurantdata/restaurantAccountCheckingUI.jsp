...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/restaurantsdata/restaurantAccountCheckingJson',
            columns: [[
                {field: 'restaurant_id', title: '餐厅ID', sortable: true},
                {field: 'name_zh_cn', title: '餐厅名称', sortable: true},
                {field: 'order_confirmed_at', title: '时间', sortable: true},
                {field: 'number', title: '单号', sortable: true},
                {field: 'packing_fee', title: '餐盒费', sortable: true},
                {field: 'line_items_total', title: '菜品金额', sortable: true},
                {field: 'order_total', title: '订单金额', sortable: true},
                {field: 'line_cost_total', title: '需付餐厅', sortable: true},
   ...
   /*      $("#export").iMenubutton({
    ...
    function expor1tReport(){
    	  $("form[id='queryForm']").attr("action", "<%=request.getContextPath()%>/restaurantsdata/exportReportrestaurantAccountChecking");
