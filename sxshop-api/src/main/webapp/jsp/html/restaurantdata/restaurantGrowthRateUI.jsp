...
<div id="productDg-toolbar" class="topjui-toolbar"
  ...
  <a id="export"  href="javascript:void(0)" onclick="expor1tReport()">导出</a>
    ...
    <form id="queryForm" class="search-box" action="">
     <input  type="text" data-toggle="topjui-datebox" data-options="id:'text1',prompt:'时间',pattern:'YYYY-mm'" id="createTimebegin" name="createTimebegin" value="" >
...
<script>
    ...
    $(function () {
       ...
       $("#productDg").iDatagrid({
            id: 'productDg',
            url: '<%=request.getContextPath()%>/restaurantsdata/restaurantGrowthRateJson',
            columns: [[
                ...
                {field: 'ordersnum', title: '订单数(本月)', sortable: true},
                {field: 'last_ordersnum', title: '订单数(上月)', sortable: true},
                {field: 'line_cost_total', title: '实付餐厅(本月)', sortable: true},
                {field: 'last_line_cost_total', title: '实付餐厅(上月)', sortable: true},
                {field: 'order_total', title: '实收客户(本月)', sortable: true},
                {field: 'last_order_total', title: '实收客户(上月)', sortable: true},
                 {field: 'delivery_fee', title: '送餐费(本月)', sortable: true},
                {field: 'last_delivery_fee', title: '送餐费(上月)', sortable: true}, 
                {field: 'packing_fee', title: '打包费(本月)', sortable: true},
                {field: 'last_packing_fee', title: '打包费(上月)', sortable: true},
                {field: 'growth_rate', title: '餐厅增长率', sortable: true}
            ]],
